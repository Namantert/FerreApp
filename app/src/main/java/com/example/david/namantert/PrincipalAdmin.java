...
public class PrincipalAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ls.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                switch (position){
                    case 0:
                        i=new Intent(PrincipalAdmin.this,Lista_Registros.class);
                        startActivity(i);
                        break;
                    case 1:
                        i=new Intent(PrincipalAdmin.this, Listas.class);
                        startActivity(i);
                        break;
                    case 2:
                        i=new Intent(PrincipalAdmin.this,Reportes.class);
                        startActivity(i);
                        break;
                    case 3:
                        i=new Intent(PrincipalAdmin.this,Compras_Registro_Clientes.class);
                        startActivity(i);
                        break;
                    case 4:
                        i=new Intent(PrincipalAdmin.this,Login.class);
    ...
    public void onBackPressed() {
        Log.d("PrincipalAdmin","onBackPressed()");
        getClass();
    }
