...
public class AdaptadorEmpleado extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        //Declarar variable
        TextView cajaCedula,cajaNombre,cajapuesto,cajaContraseña;
        ImageView foto;
        ...
        cajaContraseña=(TextView)itemView.findViewById(R.id.txtContraseñaEmpleadoP);
        ...
        cajaContraseña.setText(empleados.get(position).getContraseña());
