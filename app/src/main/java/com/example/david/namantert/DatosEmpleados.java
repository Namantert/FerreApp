...
public class DatosEmpleados {
    public static ArrayList<Empleado> traerEmpleados(Context contexto){
        ...
        //Declarar variables
        SQLiteDatabase db;
        String sql,foto,cedula,nombre,apellido,edad,puesto,sexo,contraseña;
        Empleado e;
        ...
        //Cursor
        sql="select foto, cedula, nombre, apellido, edad, puesto, sexo, contraseña from Empleados";
    ...
    public static Empleado buscarEmpleadosLogin(Context contexto,String ced1){
        ...
        //Cursor
        sql="select * from Empleados where contraseña ='"+ced1+"'";
        Cursor c=db.rawQuery(sql,null);
