...
public class Registrar_Empleado extends AppCompatActivity {
    private EditText cajaCedula,cajaNombre,cajaApellido,cajaEdad,cajaContraseña;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cajaContraseña=(EditText)findViewById(R.id.txtContraseñaEmpleado);
    ...
    public boolean validar(){
        ...
        if (cajaContraseña.getText().toString().isEmpty()){
            cajaContraseña.setError(res.getString(R.string.error_cajacontraseña));
    ...
    public void guardar(View v){
        String foto,cedula,nombre,apellido,edad,puesto,sexo,contraseña;
        Empleado e;
        if (validar()){
            if (validarCedulaRepetido()){
                ...
                e=new Empleado(foto,cedula,nombre,apellido,edad,puesto,sexo,contraseña);
    ...
    public void buscar(View v){
        ...
        if (validarCedula()){
            ...
            if (e!=null){
                ...
                cajaContraseña.setText(e.getContraseña());
                ...
                cajaCedula.setError(res.getString(R.string.error_cedula_no_existente));
                cajaCedula.requestFocus();
            }
        }
    }
    ...
    public void modificar(View v){
        Empleado e,e1;
        String nombre,apellido,edad,puesto,sexo,contraseña;
        if (validarCedula()){
            e=DatosEmpleados.buscarEmpleados(getApplicationContext(),cajaCedula.getText().toString());
            if (e!=null){
                nombre=cajaNombre.getText().toString();
                ...
                contraseña=cajaContraseña.getText().toString();
                e1=new Empleado(e.getFoto(),e.getCedula(),nombre,apellido,edad,puesto,sexo,contraseña);
